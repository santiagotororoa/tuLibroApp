    ...
    <body>
      <%@ include file="nav.jsp" %>
        ...
        <div class="main-content">
          <div class="name">
            <svg viewBox="0 0 1024 1024" width="50" class="icon" version="1.1" fill="#000000">
            ...
            <h1>
              <c:out value="${usuarioEmail.name}" /><span> Lista de deseos</span>
            </h1>
          </div>
          ...
          <c:forEach var="lista_deseos" items="${usuarioEmail.libroVenta}">
            <div class="item-list">
              ...
              <a href="javascript:void(0);" onclick="confirmarCompra(${lista_deseos.id})">comprar ahora</a>
            </div>
          </c:forEach>
        </div>
